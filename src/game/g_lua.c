...
* IRATA [*] 03/2009
*
* Small modifications are done for client entity fields
*/
#include "g_lua.h"
...
int C_gentity_ptr_to_entNum( uintptr_t addr )
{
	// no NULL address,
...
static int _et_MutePlayer(lua_State *L)
{
	...
	ent->client->sess.auto_mute_time = (duration > 0)? level.time + duration*1000 : -1;	// .auto_mute_time is actually the time to unmute
	ent->client->sess.muted_by = MUTED_BY_LUA;
...
static int _et_UnmutePlayer(lua_State *L)
{
	...
	ent->client->sess.muted_by = UNMUTED;
	ClientConfigStringChanged( ent );
...
/*
// et.trap_SendMessage( int clientNum, char *buf, int buflen )
static int _et_trap_SendMessage(lua_State *L)
{
	int clientnum = luaL_checkint(L, 1);
	const char *buf = luaL_checkstring(L, 2);
	int buflen = L_checkstring(L, 3);
	trap_SendMessage( clientnum, buf, buflen );
	return 0;
}


// et.trap_MessageStatus( int clientNum ) {
static int _et_trap_MessageStatus(lua_State *L)
{
	int clientnum = luaL_checkint(L, 1);
	trap_MessageStatus( clientnum );
	return 0;
}
*/
...
static const gentity_field_t gclient_fields[] = {
	...
	_et_gclient_addfield(multikill, FIELD_INT, FIELD_FLAG_READONLY),
	...
	_et_gclient_addfield(pers.lastHQArtyReportTime, FIELD_INT, FIELD_FLAG_READONLY),
	...
	_et_gclient_addfield(headshots, FIELD_INT, FIELD_FLAG_READONLY),
	...
	_et_gclient_addfield(pers.connected, FIELD_INT, FIELD_FLAG_READONLY), // clientConnected_t
	_et_gclient_addfield(pers.netname, FIELD_STRING, FIELD_FLAG_NOPTR),
	_et_gclient_addfield(pers.cl_guid, FIELD_STRING, FIELD_FLAG_NOPTR + FIELD_FLAG_READONLY), // since 1.3.0
#ifdef HW_BAN
	_et_gclient_addfield(pers.cg_hwguid, FIELD_STRING, FIELD_FLAG_NOPTR + FIELD_FLAG_READONLY), // since 1.3.0
#endif // HW_BAN
...
//	_et_gclient_addfield(pers.teamVoteCount, FIELD_INT, 0), //unused
	...
	_et_gclient_addfield(sess.spectatorClient, FIELD_INT, FIELD_FLAG_READONLY),
	...
	// #379 - NQ Lua mute fields (ETPub uses different code for mute  - dunno about ETPro ...)
	_et_gclient_addfield(sess.muted, FIELD_INT, 0),
	_et_gclient_addfield(sess.auto_mute_time, FIELD_INT, 0),
	_et_gclient_addfield(sess.muted_by, FIELD_INT, 0),
	...
	_et_gclient_addfield(sess.coach_team, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.damage_given, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.damage_received, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.deaths, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.game_points, FIELD_INT, 0),
	_et_gclient_addfield(sess.kills, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.referee, FIELD_INT, 0),
	_et_gclient_addfield(sess.rounds, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.spec_invite, FIELD_INT, 0),
	_et_gclient_addfield(sess.spec_team, FIELD_INT, 0),
	_et_gclient_addfield(sess.suicides, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.team_damage, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.team_kills, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.team_hits, FIELD_FLOAT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.hits, FIELD_FLOAT, FIELD_FLAG_READONLY),
	// IRATA: removed in 1.2.9 b7
	...
	_et_gclient_addfield(sess.killingSpree, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.aWeaponStats, FIELD_INT_ARRAY, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.newton, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.darwin, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.goomba, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.executions, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.poisoneer, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.kickass, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.panzernoob, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.missionair, FIELD_INT, FIELD_FLAG_READONLY),
	_et_gclient_addfield(sess.resuscetations, FIELD_INT, FIELD_FLAG_READONLY),
    _et_gclient_addfield(sess.uci, FIELD_INT, FIELD_FLAG_READONLY),
#ifdef AUTO_GUID
	_et_gclient_addfield(sess.nqKeyInfo.nquid, FIELD_STRING, FIELD_FLAG_NOPTR + FIELD_FLAG_READONLY), // since 1.3.0
#endif
	// credits
...
static const gentity_field_t gentity_fields[] = {
	...
	_et_gentity_addfield(chain, FIELD_ENTITY, FIELD_FLAG_READONLY),
	...
	_et_gentity_addfield(enemy, FIELD_ENTITY, FIELD_FLAG_READONLY),
	...
	_et_gentity_addfield(nextTrain, FIELD_ENTITY, FIELD_FLAG_READONLY),
	_et_gentity_addfield(noise_index, FIELD_INT, 0),
	_et_gentity_addfield(prevTrain, FIELD_ENTITY, FIELD_FLAG_READONLY),
	...
	_et_gentity_addfield(tagParent, FIELD_ENTITY, FIELD_FLAG_READONLY),
	_et_gentity_addfield(takedamage, FIELD_INT, 0),
	_et_gentity_addfield(tankLink, FIELD_ENTITY, FIELD_FLAG_READONLY),
	...
	_et_gentity_addfield(teamchain, FIELD_ENTITY, FIELD_FLAG_READONLY),
	_et_gentity_addfield(teammaster, FIELD_ENTITY, FIELD_FLAG_READONLY),
		...
		case F_ENTITY:
			{
				...
				int entNum = C_gentity_ptr_to_entNum( *(uintptr_t *)((byte *)ent + ofs) );
				if ( entNum < 0 ) {
					lua_pushnil(L);
				} else {
	...
	switch( type ) {
		...
		case F_GSTRING:
			...
			if ( fields[index].flags & FIELD_FLAG_NOPTR ) {
				...
				*(char **)((byte *)ent + ofs) = malloc(strlen(buffer) + 1);
				Q_strncpyz(*(char **)((byte *)ent + ofs), buffer, (int)(strlen(buffer) + 1));
			}
			return 1;
		case F_VECTOR:
		case F_ANGLEHACK:
...
// This is to set shrub levels in a silent way ...
static int _et_G_shrubbot_setlevel(lua_State *L)
{
	int clientNum = luaL_checkint(L, 1);
	...
	luaL_error(L, "Can't set the level for client \"%d\"", clientNum);
	return 0;
}
...
//	{"trap_MessageStatus",			_et_trap_MessageStatus},
	...
	{"G_shrubbot_setlevel_lua", 	_et_G_shrubbot_setlevel},
